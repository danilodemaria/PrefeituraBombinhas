 ...
 */
public class BuscaAlunoRelatorio extends javax.swing.JFrame {
    ...
    public String opcao, dataInicio1, dataFinal1;

    public BuscaAlunoRelatorio(String text, String dataInicio, String dataFinal) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaAlunoRelatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaAlunoRelatorio().setVisible(true);
            }
        });
    }
