...
public class EditarAluno extends javax.swing.JFrame {
    ...
    public EditarAluno(String id) throws SQLException {
        ResultSet rs = null;
        ...
        codigo.setText(id);
        String uf, instituicaoBanco, periodoBanco;
        ...
        while (rs.next()) {
            ...
            dataRegistro.setText(format.format(rs.getTimestamp("datacadastro")));
            ...
            telFixo.setText(rs.getString("telFixo"));
            telMovel.setText(rs.getString("telMovel"));
            curso.setText(rs.getString("curso"));
            orgaoExpedidor.setText(rs.getString("orgaoexpedidor"));
            uf = rs.getString("estado");
            instituicaoBanco = rs.getString("instituicao");
            periodoBanco = rs.getString("periodo");
            if (rs.getBoolean("segunda")) {
                segunda.setSelected(true);
            }
            if (rs.getBoolean("terca")) {
                terca.setSelected(true);
            }
            if (rs.getBoolean("quarta")) {
                quarta.setSelected(true);
            }
            if (rs.getBoolean("quinta")) {
                quinta.setSelected(true);
            }
            if (rs.getBoolean("sexta")) {
                sexta.setSelected(true);
            }
            if (rs.getBoolean("sabado")) {
                sabado.setSelected(true);

            }

            comboUF.setSelectedItem(uf);
            instituicao.setSelectedItem(instituicaoBanco);
            comboPeriodo.setSelectedItem(periodoBanco);

            if (rs.getBoolean("ativo")) {
                ativoSim2.setSelected(true);
            } else {
    ...
    private void initComponents() {
        ...
        ativoSim2 = new javax.swing.JRadioButton();
        ativoNao = new javax.swing.JRadioButton();
        jLabel23 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Atualizar Situação Aluno");
        ...
        ativoSim2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ativoSim2.setText("Sim");
        ativoSim2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ativoSim2ActionPerformed(evt);
            }
        });
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                        .addComponent(dataNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                    .addComponent(dataRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                            .addComponent(email, javax.swing.GroupLayout.PREFERRED_SIZE, 328, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(cadastrarButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(ativoSim2)
                                        .addGap(31, 31, 31)
    ...
    private void cadastrarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cadastrarButtonMouseClicked
        ...
        if (ativoSim2.isSelected()) {
            pessoa.setAtivo(true);
        } else {
            pessoa.setAtivo(false);
        }

        if (conexao.atualizaAluno(pessoa, codigo.getText())) {
            JOptionPane.showMessageDialog(null, "Atualizado com sucesso!");
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Não atualizado.Por favor verifique!");
        }

    }//GEN-LAST:event_cadastrarButtonMouseClicked

    private void ativoSim2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ativoSim2ActionPerformed
        // TODO add your handling code here:
        ativoNao.setSelected(false);
    }//GEN-LAST:event_ativoSim2ActionPerformed

    private void ativoNaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ativoNaoActionPerformed
        // TODO add your handling code here:
        ativoSim2.setSelected(false);
    ...
    private javax.swing.JRadioButton ativoSim1;
    private javax.swing.JRadioButton ativoSim2;
